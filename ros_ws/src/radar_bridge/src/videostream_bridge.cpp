...
auto VideoBridge::video_init(const std::string& shm_name, const std::string& pub_address, int width,
    ...
    if (shm_fd_ == -1) return std::unexpected("shm_open failed: " + shm_name_);
